...
import { Component, Injectable, Renderer2, Inject, Input, ViewEncapsulation, ViewChild, ElementRef, Output, EventEmitter, ChangeDetectorRef, HostListener, defineInjectable, NgModule, ChangeDetectionStrategy, NgZone, PLATFORM_ID } from '@angular/core';
...
/** @type {?} */
var pdfjsBleedingEdgeVersion = '2.7.228';
/**
 * @param {?} folder
 * @return {?}
 */
